/* ============================================================
   Shared UI components — ported from prototype components.jsx.
   CHANGED: window globals -> ESM imports/exports; React hooks imported.
   ============================================================ */
...
export function Placeholder({ label, ratio = "3 / 4", rounded = 14, tone = "gold", style }) {
...
export function Sigil({ author, size = 34 }) {
...
/* ---- Top bar ---------------------------------------------- */
export function TopBar({ onMenu, onSearch, onHome, title, scrolled }) {
  return (
...
/* ---- Volume card / row ------------------------------------ */
export function VolumeCard({ v, go, variant = "card" }) {
